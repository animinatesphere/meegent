      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="flex items-center justify-between px-5 md:px-8 pt-4 pb-3 overflow-hidden">
          ...
          <div className="flex gap-2">
            ...
            {/* NOTIFICATION BUTTON - navigates to NotificationPage */}
            <button
              className="w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center cursor-pointer transition-transform hover:scale-105"
        ...
        <div className="px-5 md:px-8 pb-6">
          ...
          <div className="flex flex-col gap-4">
            {filteredEvents2.length > 0 ? (
              filteredEvents2.map((event) => (
                <div
                  key={event.id}
                  className="p-3 md:p-4 rounded-[20px] flex gap-4 cursor-pointer"
                  style={{
                    background: "white",
                  ...
                  onClick={() => setSelectedEvent(event)}
                >
                  <div className="w-[100px] h-[100px] md:w-28 md:h-28 flex-shrink-0">
                    <img
                      src={event.ev}
                      alt={event.title}
                  ...
                  <div className="flex-1 flex flex-col justify-between py-1 border-gray-100 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      >
                        {favorites.some((fav) => fav.id === event.id) ? (
                          <svg width="20" height="20" fill="#F3A218" viewBox="0 0 24 24">
                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                          </svg>
                        ) : (
                          <svg width="20" height="20" fill="none" stroke="#F3A218" strokeWidth="2" viewBox="0 0 24 24">
                            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                          </svg>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <div className="flex items-center gap-1.5 whitespace-nowrap">
                        <img src={lo} className="w-3.5 h-3.5" alt="" />
                        <span className="text-[13px]" style={{ color: "#667085" }}>
                          {event.location}
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5 whitespace-nowrap">
                        <img src={lo2} className="w-3.5 h-3.5" alt="" />
                        <span className="text-[13px]" style={{ color: "#667085" }}>
                          {event.date}
                        </span>
                      </div>
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <span className="font-bold whitespace-nowrap" style={{ color: "#E8960C", fontSize: "15px" }}>
                        {event.price}{" "}
                        <span className="text-[11px] font-normal text-[#98A2B3]">
                          {event.perPerson ? "/Person" : ""}
                        </span>
                      </span>
                      <div className="flex -space-x-[6px] items-center flex-shrink-0">
                        <div className="w-[22px] h-[22px] rounded-full overflow-hidden border-[1.5px] border-white bg-[#FDE4B4] relative z-[1]"><img src={memoji1} className="w-full h-full object-cover" /></div>
                        <div className="w-[22px] h-[22px] rounded-full overflow-hidden border-[1.5px] border-white bg-[#FDE4B4] relative z-[2]"><img src={memoji2} className="w-full h-[22px] object-cover" /></div>
                        <div className="w-[22px] h-[22px] rounded-full overflow-hidden border-[1.5px] border-white bg-[#FDE4B4] relative z-[3]"><img src={memoji3} className="w-full h-[22px] object-cover" /></div>
                        <div className="w-[22px] h-[22px] rounded-full overflow-hidden border-[1.5px] border-white bg-[#FDE4B4] relative z-[4]"><img src={memoji4} className="w-full h-[22px] object-cover" /></div>
                        <div className="w-[22px] h-[22px] rounded-full overflow-hidden border-[1.5px] border-white bg-[#FDE4B4] relative z-[5]"><img src={memoji5} className="w-full h-[22px] object-cover" /></div>
                        <div
                          className="w-[22px] h-[22px] rounded-full border-[1.5px] border-white flex items-center justify-center relative z-[6] -ml-1 text-[#FFFFFF]"
                          style={{ background: "#F3A218" }}
                        >
                          <span className="text-[7.5px] font-bold text-white">+34</span>
                        </div>
                      </div>
                    </div>
                  </div>
